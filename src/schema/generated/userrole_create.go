...
func (urc *UserRoleCreate) SetDeletedBy(s string) *UserRoleCreate {
	urc.mutation.SetDeletedBy(s)
	return urc
}

// SetIsDeleted sets the "is_deleted" field.
func (urc *UserRoleCreate) SetIsDeleted(b bool) *UserRoleCreate {
	urc.mutation.SetIsDeleted(b)
	return urc
}

// SetNillableIsDeleted sets the "is_deleted" field if the given value is not nil.
func (urc *UserRoleCreate) SetNillableIsDeleted(b *bool) *UserRoleCreate {
	if b != nil {
		urc.SetIsDeleted(*b)
	}
	return urc
...
func (urc *UserRoleCreate) defaults() {
	...
	if _, ok := urc.mutation.IsDeleted(); !ok {
		v := userrole.DefaultIsDeleted
		urc.mutation.SetIsDeleted(v)
	}
...
func (urc *UserRoleCreate) check() error {
	...
	if _, ok := urc.mutation.CreatedBy(); !ok {
		return &ValidationError{Name: "created_by", err: errors.New(`generated: missing required field "UserRole.created_by"`)}
	}
	...
	if _, ok := urc.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`generated: missing required field "UserRole.updated_by"`)}
	}
	if _, ok := urc.mutation.DeletedBy(); !ok {
		return &ValidationError{Name: "deleted_by", err: errors.New(`generated: missing required field "UserRole.deleted_by"`)}
	}
	if _, ok := urc.mutation.IsDeleted(); !ok {
		return &ValidationError{Name: "is_deleted", err: errors.New(`generated: missing required field "UserRole.is_deleted"`)}
	}
	return nil
}
...
func (urc *UserRoleCreate) createSpec() (*UserRole, *sqlgraph.CreateSpec) {
	...
	if value, ok := urc.mutation.DeletedBy(); ok {
		_spec.SetField(userrole.FieldDeletedBy, field.TypeString, value)
		_node.DeletedBy = value
	}
	if value, ok := urc.mutation.IsDeleted(); ok {
